...
A base de dados utilizada foi de uma empresa fictícia, no formato .csv. Sendo divididas em cinco tabelas, relacionadas entre si. O conjuto de dados inclui informações sobre:<br>
